// TODO(domain): revert `siteConfig.url` to the real production domain
// (https://summerfindslab.com) once the custom domain is purchased and
// connected in Vercel (see PROJECT_BIBLE §9 T-013). Until then we ship the
// live Vercel URL so canonical/OG/sitemap/JSON-LD/llms.txt all resolve to a
// real, reachable origin. This value is the single source — every metadata,
// OG, JSON-LD, sitemap and llms.txt reference is derived from it.
