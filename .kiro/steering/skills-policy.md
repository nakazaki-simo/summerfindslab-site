...
| `https://github.com/obra/superpowers` | `main` | `skills/` | 14 |
| `https://github.com/obra/superpowers-lab` | `main` | `skills/` | 5 |
| `https://github.com/yusufkaraaslan/Skill_Seekers` | `main` | `skills/skill-seekers/` | 1 |
